    ...
    <div className="min-h-screen bg-zinc-950 text-white">
      ...
      <main className="mx-auto max-w-5xl px-6 py-16">
        <div className="max-w-2xl">
          ...
          <h1 className="mt-3 text-4xl font-bold">Mpoket support and business contact</h1>
        ...
        <section className="mt-10 grid gap-4 md:grid-cols-3">
          <ContactCard title="Email" value="support@mpoket.local" />
        ...
        <section className="mt-8 rounded-md border border-zinc-800 bg-zinc-900/60 p-6">
          ...
          <p className="mt-3 text-zinc-400">
            For any payment link, service entry, refund clarification, transaction history, or account access request, contact the Mpoket owner using the details above.
          </p>
        </section>
      </main>
    </div>
